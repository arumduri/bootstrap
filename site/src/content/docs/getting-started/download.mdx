...
바로 사용할 수 있는 컴파일된 **Bootstrap v[[config:current_version]]** 코드를 다운로드해서 프로젝트에 포함시킬 수 있습니다. 다음이 포함되어 있습니다:
...
<a href="[[config:download.dist]]" class="btn btn-bd-primary">다운로드</a>
...
<a href="[[config:download.source]]" class="btn btn-bd-primary">소스 다운로드</a>

## 예시

[예시]([[docsref:/examples]])를 다운로드하고 확인하고 싶다면 이미 만들어진 예시를 사용해 볼 수도 있습니다:

<a href="[[config:download.dist_examples]]" class="btn btn-bd-primary">예시 다운로드</a>
...
<Callout type="warning">
**Yarn 2 (Yarn Berry)부터는 기본적으로 `node_modules` 경로를 지원하지 않습니다**: [Sass & JS 예제](https://github.com/twbs/examples/tree/main/sass-js)을 사용할 시에는 일부 조정이 필요합니다:
...
커뮤니티에서 관리하는 Visual Studio Code용 [IntelliSense 확장](https://marketplace.visualstudio.com/items?itemName=hossaini.bootstrap-intellisense) 을 통해 Bootstrap 클래스에 대한 자동완성을 사용해보세요.

<a href="https://marketplace.visualstudio.com/items?itemName=hossaini.bootstrap-intellisense" class="btn btn-bd-primary">VS Code Marketplace에서 보기</a>
