...
`.col-auto` 클래스를 사용해, 수평 방향의 레이아웃을 만듭니다. [gutter modifier classes]({{< docsref "/layout/gutters" >}})를 추가함으로써 수평 방향과 수직 방향에 거터를 적절하게 줄 수 있습니다. `.align-items-center`를 사용해 폼 요소를 중앙에 오게 해 `.form-checkbox`의 위치가 예쁘게 적용되었습니다.
